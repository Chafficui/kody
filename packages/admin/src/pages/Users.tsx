  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Manage admin users for the Kody dashboard.</p>
      </div>
      ...
      <div className="rounded-xl border border-border bg-background p-5">
        ...
        <form onSubmit={handleAddUser} className="flex flex-col gap-3 sm:flex-row sm:items-end">
          ...
          <button
            type="submit"
            disabled={addingUser}
            className="shrink-0 rounded-lg bg-primary px-5 py-2 text-sm font-semibold text-primary-foreground shadow-md shadow-primary/25 transition-colors hover:bg-primary-dark disabled:cursor-not-allowed disabled:opacity-60"
          >
